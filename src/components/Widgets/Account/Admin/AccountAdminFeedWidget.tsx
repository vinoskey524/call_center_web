...
/* Custom packages */
import './AccountAdminFeedWidget.css';
...
const AccountAdminFeedWidget = (props: propsType, ref: any) => {
    /* ------------------------------------ Constants ------------------------------------- */
    ...
    const component = <>
        <div className='aafw_scaffold prevent_select'>
            <div className='aafw_checkbox_container'>
                <input className='aafw_checkbox' type='checkbox' />
            </div>
            <div className='aafw_hyphen' />

            <p className='aafw_full_name one_line'>{accountData.fullName}</p>
            <div className='aafw_hyphen' />

            <p className='aafw_username one_line'>{accountData.username}</p>
            <div className='aafw_hyphen' />

            <p className='aafw_rights one_line'>{accountData.rights}</p>
            <div className='aafw_hyphen' />

            <p className='aafw_status one_line'>{accountData.status}</p>
            <div className='aafw_hyphen' />

            <div className='aafw_action_btn_container'>
                ...
                <img className='aafw_action_btn_icon btn_opacity' style={{ marginInline: 20 }} src={edit_icon} onClick={() => { }} />
                <img className='aafw_action_btn_icon btn_opacity' src={trash_icon} title='Delete' onClick={() => { }} />
            </div>
        </div>
    </>;
...
export default forwardRef(AccountAdminFeedWidget);