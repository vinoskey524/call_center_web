...
const ProductFeedWidget = (props: propsType, ref: any) => {
    ...
    const component = <>
        <div className='prfew_scaffold btn_opacity'>
            <img className='prfew_img' src='logo192.png' />
            <div style={{ flex: 1, marginLeft: 6 }}>
                <div className='prfew_name'>Nom du produit Nom du produitNom du produitNom du produitNom du produit  du produitNom du produitNom du produi du produitNom du produitNom du produi</div>
